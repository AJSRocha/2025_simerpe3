...
jnll = function(par) {
  ...
  nT     = length(Ct)
  catch = rep(0, nT) * alpha   # Ensures catch becomes an AD type
  Bt = rep(0, nT) * alpha     # Ensures Bt becomes an AD type
...
predicted_catch = obj7$report()$catch
predicted_Bt = obj7$report()$Bt
predicted_N0 = obj7$report()$N0
predicted_Rt = obj7$report()$Rt
```
